...
public class EmailService implements EmailSender{
    ...
    public String buildRegisterEmail(String name, String link) {
        return "<!DOCTYPE html>\n" +
                ...
                "              <p style=\"margin: 0;\">Thank you for registering to Automative Part. You can activate your account with the following button below</p>\n" +
                "            </td>\n" +
                "          </tr>\n" +
                "          <!-- end copy -->\n" +
                "\n" +
                ...
                "                          <a href="+link+" target=\"_blank\" style=\"display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;\">Activate Now</a>\n" +
                "                        </td>\n" +
                "                      </tr>\n" +
                "                    </table>\n" +
                "                  </td>\n" +
                ...
                "              <p style=\"margin: 0;\">Cheers,<br> Automative Part</p>\n" +
                "            </td>\n" +
                "          </tr>\n" +
                "          <!-- end copy -->\n" +
                "\n" +
                ...
                "              <p style=\"margin: 0;\">You received this email because we received a request for registration to Automative Part. If you didn't request such registration you can safely delete this email.</p>\n" +
                "            </td>\n" +
                "          </tr>\n" +
                "          <!-- end permission -->\n" +
                "\n" +
                ...
                "          <tr>\n" +
                "            <td align=\"center\" bgcolor=\"#e9ecef\" style=\"padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;\">\n" +
                "              <p style=\"margin: 0;\">To stop receiving these emails, you can <a href="+link+" target=\"_blank\">unsubscribe</a> at any time.</p>\n" +
